...
def sin(x: _ArrayLike[Any], out: ndarray[Any]=...) -> _ArrayLike[Any]: ...
def cos(x: _ArrayLike[Any], out: ndarray[Any]=...) -> _ArrayLike[Any]: ...
pi: float
def arange(start:Any, stop:Any=..., step:Any=..., dtype:DtypeType=None) -> ndarray[Any]: ...
